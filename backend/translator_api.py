...
async def translate_text_openai(text: str, source_lang: str, target_lang: str) -> str:
    """Simple, reliable text translation using OpenAI API"""
...
def create_simple_pdf(text: str, filename: str = "translated.pdf") -> bytes:
    ...
    try:
        ...
        for paragraph in paragraphs:
            ...
            for word in words:
                ...
                if len(test_line) * 6 < text_width:  # Rough character width estimate
...
async def root():
    return {
        ...
        "version": "7.0 - Simplified & Reliable",
        "status": "OK",
        "endpoints": ["/translate", "/translate-pdf"],
        "features": [
            "Simple, reliable text translation",
...
async def translate_pdf(
    ...
    """Simple PDF translation endpoint"""
    temp_file_path = None
    ...
    try:
        ...
        translated_pdf_content = create_simple_pdf(translated_text, file.filename)
